...
/*    STARTX  STARTY    WIDTH       HEIGHT    LABEL       ID     VALIDITY		pressed  colour*/
		...
		{260,	187,	WIDTH,		HEIGHT,		"SAV3",			7,		1,		0,	 	LCD_COLOR_LIGHTBLUE},
		{255,   130,    WIDTH+12,      (HEIGHT/2),    "+",         8,      1,      0,      LCD_COLOR_LIGHTBLUE},
		{255,   150,    WIDTH+12,      (HEIGHT/2),    "-",         9,      1,      0,      LCD_COLOR_LIGHTBLUE}
};
#endif
/**************************Button Methods********************************/
