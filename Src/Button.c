...
/*    STARTX  STARTY    WIDTH       HEIGHT    LABEL       ID     VALIDITY		pressed*/
		...
		{10,	180,	WIDTH,		HEIGHT,		"LD",			3,		1,  	0,	 	LCD_COLOR_WHITE},
		{70,	180,	WIDTH,		HEIGHT,		"STR",			4,		1,		0,	 	LCD_COLOR_GRAY},
		{140,	180,	WIDTH,		HEIGHT,		"SAV1",			5,		1,		0,	 	LCD_COLOR_GRAY},
		{200,	180,	WIDTH,		HEIGHT,		"SAV2",			6,		1,		0,	 	LCD_COLOR_GRAY},
		{260,	180,	WIDTH,		HEIGHT,		"SAV3",			7,		1,		0,	 	LCD_COLOR_GRAY},
		{NULL,	NULL,	NULL,		NULL,		NULL,			0,		0,		0,	 	LCD_COLOR_GRAY}
};
#endif
/**************************Button Methods********************************/
